...
#'
#' @param pref_2017_HoR_PR download_2017_HoR()で読み込んだ生のデータフレーム
#'
#' @return 整形済みのtibble（municipality, party, votes）
#'
clean_pref_2017_HoR_PR <- function(pref_2017_HoR_PR) {
  
  # 1. ヘッダーが5行目から始まるため、5行目以降を対象とする
  df_raw <- pref_2017_HoR_PR %>%
    slice(5:n()) 
