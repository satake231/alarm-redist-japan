#' Download 2017 House of Representatives Elections Data
#'
...
download_2017_HoR_PR <- function(pref_code){
  ...
  if(file.exists(paste0('data-raw/', pref_code, '_2017_HoR.xls')) == TRUE){

    # read file
    pref_2017_HoR <- readxl::read_excel(paste0('data-raw/', pref_code, '_2017_HoR.xls'))
    ...
    download.file(paste0('https://www.soumu.go.jp' ,
                        link_PR_party),
                  paste0('data-raw/', pref_code, '_2017_HoR.xls'))
