...
ggsave(filename = "hokkaido_optimal_2050_conditional.png", plot = optimal_plot, width = 10, height = 8, dpi = 300)
...
ggsave(filename = "hokkaido_ishikari_optimal_2050_conditional.png", plot = optimal_plot_ishikari, width = 10, height = 8, dpi = 300)
