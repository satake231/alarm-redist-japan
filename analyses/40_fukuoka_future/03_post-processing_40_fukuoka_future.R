###############################################################################
# Post-processing for `40_fukuoka_future`
...
# Repair adjacency list for Fukuoka specific connections
...
cat("Number of valid plans:", nrow(functioning_results), "\n")
