...
ggsave(filename = "niigata_enacted_2022.png", plot = enacted_map, width = 10, height = 8, dpi = 300, bg = "white")
...
ggsave(filename = "niigata_optimal_2022.png", plot = optimal_map, width = 10, height = 8, dpi = 300, bg = "white")
